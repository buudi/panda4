import { Box, SimpleGrid, GridItem, Text, Avatar, Center } from "@chakra-ui/react";
                    ...
                    <SimpleGrid columns={20}>
                        ...
                        <GridItem mt={10} colSpan={8}>
                            <SimpleGrid columns={9}>
                                ...
                                <GridItem m={3} colSpan={3}><Box><FiSettings /></Box></GridItem>
                                <GridItem colSpan={3}><Box><Avatar src="https://bit.ly/broken-link" /></Box></GridItem>
                            </SimpleGrid>
